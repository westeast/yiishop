	...
	<table class="contentTab listTab" width="100%">
		...
		<?php foreach($data as $key=>$item){ ?>
			<tr>
				...
				<td>
					<?php echo Yii::app()->user->id==$item->id&&$item->id==1?CHtml::link('重置权限',array('/admin/authority/reset/')):CHtml::link('权限分配',array('/admin/authority/edit/','id'=>$item->id));?>
				</td>
				<td><?php echo CHtml::link('<img src="/style/admin/images/edit.gif">',array('/admin/admin/edit/','id'=>$item->id)); ?> <?php echo CHtml::link('<img src="/style/admin/images/del.gif">',array('/admin/admin/delete/','id'=>$item->id),array('class'=>'delete','id'=>$item->id)); ?></td>
			</tr>
		<?php }?>
		<tr>
