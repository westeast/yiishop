	...
	<table class="contentTab listTab" width="100%">
		...
		<?php foreach($data as $key=>$item){ ?>
			<tr>
				...
				<td><?php echo CHtml::link('<img src="/style/admin/images/edit.gif">',array('/admin/news_comment/edit/','id'=>$item->id)); ?> <?php echo CHtml::link('<img src="/style/admin/images/del.gif">',array('/admin/news_comment/delete/','id'=>$item->id),array('class'=>'delete','id'=>$item->id)); ?></td>
			</tr>
		<?php }?>
		<tr>
